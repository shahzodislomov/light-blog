...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col items-center justify-center py-24 mx-auto max-w-2xl space-y-12">
      <h1 className="text-5xl max-md:text-3xl font-mono text-center">
