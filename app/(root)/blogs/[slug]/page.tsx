...
import { content, authors } from "@/constants";
import Link from "next/link";

const SlugPage = ({ params }: { params: { slug: string } }) => {
  return (
    <div className="pt-[15vh] max-w-5xl mx-auto">
      <h1 className="lg:text-6xl md:text-5xl text-4xl font-mono">
      ...
      <div className="flex md:gap-12 max-md:flex-col-reverse mt-12 relative">
        <div className="flex flex-col space-y-3">
          <div className="sticky top-36">
            <p className="flex flex-col max-md:flex-row md:space-y-3 max-md:space-x-3 mt-4">
              Share
            </p>
      ...
      <div className="flex mt-6 gap-6 items-center max-md:flex-col">
        ...
        <div className="flex-1 flex flex-col space-y-4">
          <h2 className="text-3xl font-mono">Thomas Macaulay</h2>
          <p className="line-clamp-2 text-muted-foreground">
            Thomas Macaulay is a writer based in New York City. He is interested
            in all tech things, science, and, photography related, and likes to
            yo-yo in
          </p>
          <Link
            href={"/"}
