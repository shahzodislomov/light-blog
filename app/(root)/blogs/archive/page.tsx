  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="relative min-h-[40vh] flex items-center justify-end flex-col">
        <p className="text-lg min-h-[40vh] flex items-center justify-end flex-col">
          Showing Posts from
        </p>
        <h2 className="text-center text-4xl section-title font-mono mt-2">
          <span>Archive</span>
        </h2>
      ...
      <div className="flex flex-col scroll-py-3 mt-8">
        <div className="relative">
          <span className="text-5xl font-mono relative z-20">2023</span>
